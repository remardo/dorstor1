...
export function homeSeo(): RouteSeo {
  return {
    ...
    description:
      'Доррен — B2B поставщик дверной фурнитуры для производственных предприятий. Доводчики, глазки, цилиндры, приводы от ASSA ABLOY, DORMA, NOTEDO, DORMAKABA. Оптовые поставки по всей России. Отгрузка от 1 рабочего дня.',
    keywords:
      'дверная фурнитура оптом, фурнитура для дверей B2B, доводчики дверные, дверные глазки, цилиндровые механизмы, ASSA ABLOY, DORMA, NOTEDO, DORMAKABA, ARMADILLO, APECS, фурнитура для фабрик, комплектующие для дверей, Доррен, купить дверную фурнитуру оптом',
    canonical: `${BASE_URL}/`,
    structuredData: [
...
export function productSeo(product: Product): RouteSeo {
  return {
    ...
    } Оптовая цена по запросу. Доставка по РФ. B2B поставщик Доррен.`,
...
export const STATIC_SEO: Record<string, RouteSeo> = {
  '/payment': {
    ...
    description:
      'Условия оплаты дверной фурнитуры в Доррен. Безналичный расчёт с НДС и без НДС, отсрочка платежа до 30 дней, предоплата. Полный пакет документов для бухгалтерии. B2B расчёты для юридических лиц и ИП.',
    keywords:
      'оплата дверной фурнитуры, безналичный расчёт, B2B оплата, отсрочка платежа, оплата с НДС, оплата без НДС, счёт на оплату, документооборот, Доррен оплата',
  ...
  '/delivery': {
    ...
    description:
      'Доставка дверной фурнитуры от ДОРРЕН по всей России: отгрузка со склада, самовывоз в Москве, отправка транспортными компаниями. Прозрачные сроки и сопровождение B2B поставок.',
    keywords:
      'доставка дверной фурнитуры, доставка по россии, самовывоз москва, логистика b2b, отгрузка со склада, доррен доставка',
  ...
  '/warranty': {
    ...
    description:
      'Гарантийные условия на дверную фурнитуру Доррен. 100% оригинальная продукция. Гарантия производителя до 5 лет (ASSA ABLOY, DORMA). Возврат в течение 14 дней. Обмен, ремонт, рекламации. Прозрачные условия для B2B клиентов.',
    keywords:
      'гарантия дверная фурнитура, возврат фурнитуры, гарантия ASSA ABLOY, гарантия DORMA, гарантия NOTEDO, возврат товара, обмен фурнитуры, рекламация, Доррен гарантия, оригинальная продукция',
  ...
  '/about': {
    ...
    description:
      'Доррен — поставщик дверной фурнитуры для предприятий и дверных фабрик. Комплексные B2B поставки, стабильный склад, техническая экспертиза и логистика по всей России.',
    keywords:
      'о компании доррен, b2b поставщик дверной фурнитуры, поставщик фурнитуры для фабрик, дверная фурнитура оптом, доррен москва',
